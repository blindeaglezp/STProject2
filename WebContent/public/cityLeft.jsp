...
<body>
	<div class="sidebar" id="sidebar">
		...
		<ul class="nav nav-list">
			<li><a
				href="<%=request.getContextPath()%>/servlet/CityServlet?type=toIndex">
					<img
			...
			<li><a
				href="<%=request.getContextPath()%>/servlet/CityServlet?type=toUserManage">
					<img
			...
			<li><a
				href="<%=request.getContextPath()%>/servlet/CityServlet?type=toCountyManage">
					<img
					src="<%=request.getContextPath()%>/assets/css/images/iconfont-category.png"
					width="18" height="15" /> <span class="menu-text"> 县管理 </span>
			</a></li>

			<li><a
				href="<%=request.getContextPath()%>/servlet/CityServlet?type=toCityProjectManage">
					<img
					src="<%=request.getContextPath()%>/assets/css/images/iconfont-category.png"
					width="18" height="15" /> <span class="menu-text"> 市级项目管理 </span>
			</a></li>

			<li><a
				href="<%=request.getContextPath()%>/servlet/CityServlet?type=toCountyProjectManage">
					<img
					src="<%=request.getContextPath()%>/assets/css/images/iconfont-table.png"
					width="18" height="15" /> <span class="menu-text"> 县级项目查看 </span>
			</a></li>
		</ul>
		<!-- /.nav-list -->
	</div>
