...
<body onload="javascript:projectTotal();">
	...
	<div class="right">
		<div class="projectRight">
			...
			</select> <select class="sel_allCounty pp_sel"
				onChange="queryProjectByCondition();">
				<option value="0" selected>选择县</option>
			</select> <select class="sel_allClass pp_sel" onchange="queryRegByClass();">
			...
			</select> <select class="sel_allItem pp_sel"
				onchange="queryProjectByCondition();">
				<option value="0" selected>选择项</option>
			</select> <input placeholder="文号" style="margin-top: 10px;"
				class="provinceRfc" type="text" /> <input placeholder="项目名"
				style="margin: 10px 0 0 10px;" class="projectName" type="text" />
			<button type="button" class="queryProjectByCondition" id="btn_select">查询</button>
			<button type="button" class="addProvinceProject" id="btn_select">添加项目</button>
...
>>>>>>> 52a4e923dc9128f775c70de26a1493909000d4c8
				</tr>
			...
			<!-- <div class="content">
				...
				<p>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 合计<input type="text"
						class="totalBudget txt" />
				</p>
				<p>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 中央<input type="text"
						class="centreBudget txt" />
				</p>
				<p>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 省级<input type="text"
						class="provinceBudget txt" />
				</p>
				<p>
					省级预算<input type="text" class="cityLocalBudget txt" />
				</p>
				<p>
					&nbsp;&nbsp;&nbsp; 支付数<input type="text" class="cityLocalCost txt" />
				</p>
				<p>
					支付进度<input type="text" class="cityLocalPercent txt" />
				</p>
				<div class="div_assign">
					<span class="title_assign">分配</span>
					<div class="add_assign">+</div>
					<br /> <br />
					<div class="item_assign">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;市<input
							type="text" class="city_assign" />
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;县<input
							type="text" class="county_assign" /> <br /> 预算指标<input
							type="text" class="other_budget" /> &nbsp;&nbsp;&nbsp;支付数<input
							type="text" class="other_cost" /> <br /> 支付进度<input type="text"
							class="other_percent txt" />
					</div>
				</div>
